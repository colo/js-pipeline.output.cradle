...
const debug = require('debug')('js-pipeline.output.Cradle'),
      debug_events = require('debug')('js-pipeline.output.Cradle:Events'),
      debug_internals = require('debug')('js-pipeline.output.Cradle:Internals')
